...
class BlockServiceApi {
  BlockServiceApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  final ApiClient apiClient;

  /// Performs an HTTP 'POST /v1/blocks' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [GrpcCreateBlockRequest] body (required):
  Future<Response> blockServiceCreateBlockWithHttpInfo(GrpcCreateBlockRequest body) async {
