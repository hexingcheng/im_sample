                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    NowFanmmetingListView(
                        homeVM.fanMeetings[FanMeetingState.now] ?? []),
                    const SizedBox(height: 10),
                    FutureFanMeetingListView(
                      homeVM.fanMeetings[FanMeetingState.future] ?? [],
                    ),
                              ...
                              builder: (context, hot, child) {
                                ...
                                return GridView.count(
                                  ...
                                  children: List.generate(
                                    ...
                                    (index) => TalentCard(
                                      imgHeight: imgHeight,
                                      imageUrl: hot[index].mainSquareImageUrl,
                                      name: hot[index].displayName,
                                      genre: hot[index].genre[0],
                                    ),
                                  ).toList(),
                                );
                              },
